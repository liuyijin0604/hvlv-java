...
public class TnTWebServiceLocator extends org.apache.axis.client.Service implements com.hvlv.microservices.apiService.hvlvApiService.allied.TnTWebService {
    ...
    private java.lang.String TTWSPort_address = "http://neptune.alliedexpress.com.au:8080/ttws-ejb/TTWS";
    ...
    public com.hvlv.microservices.apiService.hvlvApiService.allied.TTWS getTTWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hvlv.microservices.apiService.hvlvApiService.allied.TTWSBindingStub _stub = new com.hvlv.microservices.apiService.hvlvApiService.allied.TTWSBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hvlv.microservices.apiService.hvlvApiService.allied.TTWS.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hvlv.microservices.apiService.hvlvApiService.allied.TTWSBindingStub _stub = new com.hvlv.microservices.apiService.hvlvApiService.allied.TTWSBindingStub(new java.net.URL(TTWSPort_address), this);
                _stub.setPortName(getTTWSPortWSDDServiceName());
                return _stub;
            }
        }
