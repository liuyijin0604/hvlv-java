...
public class Job  implements java.io.Serializable {
    ...
    private JobError[] jobErrors;

    private Note[] jobNotes;

    private int jobNumber;

    private java.lang.String jobStatus;

    private JobStop[] jobStops;
    ...
    private ElectronicSignature[] signatures;
     ...
     * @return cubedItems
     */
    public CubedItem[] getCubedItems() {
        return cubedItems;
    }
     ...
     * @param cubedItems
     */
    public void setCubedItems(CubedItem[] cubedItems) {
        this.cubedItems = cubedItems;
    }

    public CubedItem getCubedItems(int i) {
        return this.cubedItems[i];
    }

    public void setCubedItems(int i, CubedItem _value) {
    ...
    public void setItems(int i, Item _value) {
        this.items[i] = _value;
    }
     ...
     * @param jobErrors
     */
    public void setJobErrors(JobError[] jobErrors) {
        this.jobErrors = jobErrors;
    }

    public JobError getJobErrors(int i) {
        return this.jobErrors[i];
    }

    public void setJobErrors(int i, JobError _value) {
     ...
     * @param jobNotes
     */
    public void setJobNotes(Note[] jobNotes) {
        this.jobNotes = jobNotes;
    }

    public Note getJobNotes(int i) {
        return this.jobNotes[i];
    }

    public void setJobNotes(int i, Note _value) {
     ...
     * @param jobStops
     */
    public void setJobStops(JobStop[] jobStops) {
        this.jobStops = jobStops;
    }

    public JobStop getJobStops(int i) {
        return this.jobStops[i];
    }

    public void setJobStops(int i, JobStop _value) {
    ...
    public void setPods(int i, POD _value) {
        this.pods[i] = _value;
    }
     ...
     * @param scannings
     */
    public void setScannings(Scanning[] scannings) {
        this.scannings = scannings;
    }

    public Scanning getScannings(int i) {
        return this.scannings[i];
    }

    public void setScannings(int i, Scanning _value) {
     ...
     * @return signatures
     */
    public ElectronicSignature[] getSignatures() {
        return signatures;
    }
     ...
     * @param signatures
     */
    public void setSignatures(ElectronicSignature[] signatures) {
        this.signatures = signatures;
    }

    public ElectronicSignature getSignatures(int i) {
        return this.signatures[i];
    }

    public void setSignatures(int i, ElectronicSignature _value) {
