...
import com.hvlv.microservices.apiService.hvlvApiService.service.GVAusPostAPIService;
...
@RestController
public class GVAusPostAPIController {
...
//    AusPostAPIService ausPostAPIService;
    ...
    @PostMapping("/gvausPost/getAccounts")
    public JsonResultBean ausPostGetAccounts() throws Exception {
        String id_test="1014445357";
        GVAusPostAPIService ausPostAPIService =new GVAusPostAPIService();
    ...
    @PostMapping("/gvausPost/validateAddress")
    ...
    @PostMapping("/gvausPost/getItemPrices")
    ...
    @PostMapping("/gvausPost/getShipments")
    ...
    @PostMapping("/gvausPost/createShipments")
    ...
    @PostMapping("/gvausPost/createIntShipments")
...
//        }
    ...
    @PostMapping("/gvausPost/updateShipment")
    ...
    @PostMapping("/gvausPost/updateIntShipment")
    ...
    @PostMapping("/gvausPost/updateItems")
    ...
    @PostMapping("/gvausPost/deleteShipment")
    ...
    @PostMapping("/gvausPost/deleteItem")
    ...
    @PostMapping("/gvausPost/getOrder")
    ...
    @PostMapping("/gvausPost/createOrderFromShipments")
    ...
    @PostMapping("/gvausPost/createOrderIncludingShipments")
...
//            }
    ...
    @PostMapping("/gvausPost/createOrderIncludingShipments2014")
    ...
    @PostMapping("/gvausPost/getOrderSummary")
    ...
    @PostMapping("/gvausPost/createLabels")
    ...
    @PostMapping("/gvausPost/getLabel")
    ...
    @PostMapping("/gvausPost/trackItems")
