...
public class Vehicle  implements java.io.Serializable {
    private com.hvlv.microservices.apiService.hvlvApiService.allied.GeographicAddress location;
    ...
    public Vehicle(
           com.hvlv.microservices.apiService.hvlvApiService.allied.GeographicAddress location,
           int vehicleID) {
     ...
     * @return location
     */
    public com.hvlv.microservices.apiService.hvlvApiService.allied.GeographicAddress getLocation() {
        return location;
    }
     ...
     * @param location
     */
    public void setLocation(com.hvlv.microservices.apiService.hvlvApiService.allied.GeographicAddress location) {
        this.location = location;
    }
