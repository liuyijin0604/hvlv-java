...
public class JobLabel  extends Job implements java.io.Serializable {
    private ItemLabel[] itemsLabel;
     ...
     * @return itemsLabel
     */
    public ItemLabel[] getItemsLabel() {
        return itemsLabel;
    }
     ...
     * @param itemsLabel
     */
    public void setItemsLabel(ItemLabel[] itemsLabel) {
        this.itemsLabel = itemsLabel;
    }

    public ItemLabel getItemsLabel(int i) {
        return this.itemsLabel[i];
    }

    public void setItemsLabel(int i, ItemLabel _value) {
