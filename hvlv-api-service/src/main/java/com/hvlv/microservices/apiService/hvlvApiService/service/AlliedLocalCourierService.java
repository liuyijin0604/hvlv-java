...
@Service
public class AlliedLocalCourierService extends HvlvService implements AlliedInterface{
    ...
    public AlliedLocalCourierService() {
    ...
    public JsonResultBean manifestAllied(JSONObject jsonData)
    {
        ...
        try
        {
            ...
            Account account = ttws.getLocalCourierAccountDefaults(this.signatureKey,
                    this.accountCode,
