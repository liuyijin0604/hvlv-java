...
public class JobExt  implements java.io.Serializable {
    ...
    private com.hvlv.microservices.apiService.hvlvApiService.allied.ItemExt[] itemsExt;

    private com.hvlv.microservices.apiService.hvlvApiService.allied.Job job;
    ...
    public JobExt(
           ...
           com.hvlv.microservices.apiService.hvlvApiService.allied.ItemExt[] itemsExt,
           com.hvlv.microservices.apiService.hvlvApiService.allied.Job job,
     ...
     * @return itemsExt
     */
    public com.hvlv.microservices.apiService.hvlvApiService.allied.ItemExt[] getItemsExt() {
        return itemsExt;
    }
     ...
     * @param itemsExt
     */
    public void setItemsExt(com.hvlv.microservices.apiService.hvlvApiService.allied.ItemExt[] itemsExt) {
        this.itemsExt = itemsExt;
    }

    public com.hvlv.microservices.apiService.hvlvApiService.allied.ItemExt getItemsExt(int i) {
        return this.itemsExt[i];
    }

    public void setItemsExt(int i, com.hvlv.microservices.apiService.hvlvApiService.allied.ItemExt _value) {
     ...
     * @return job
     */
    public com.hvlv.microservices.apiService.hvlvApiService.allied.Job getJob() {
        return job;
    }
     ...
     * @param job
     */
    public void setJob(com.hvlv.microservices.apiService.hvlvApiService.allied.Job job) {
        this.job = job;
    }
