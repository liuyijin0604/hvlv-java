...
public class JobPrice  implements java.io.Serializable {
    ...
    private com.hvlv.microservices.apiService.hvlvApiService.allied.JobCharge[] surcharges;
    ...
    public JobPrice(
           ...
           double jobCharge,
           com.hvlv.microservices.apiService.hvlvApiService.allied.JobCharge[] surcharges,
           double totalCharge) {
           this.errors = errors;
     ...
     * @return surcharges
     */
    public com.hvlv.microservices.apiService.hvlvApiService.allied.JobCharge[] getSurcharges() {
        return surcharges;
    }
     ...
     * @param surcharges
     */
    public void setSurcharges(com.hvlv.microservices.apiService.hvlvApiService.allied.JobCharge[] surcharges) {
        this.surcharges = surcharges;
    }

    public com.hvlv.microservices.apiService.hvlvApiService.allied.JobCharge getSurcharges(int i) {
        return this.surcharges[i];
    }

    public void setSurcharges(int i, com.hvlv.microservices.apiService.hvlvApiService.allied.JobCharge _value) {
