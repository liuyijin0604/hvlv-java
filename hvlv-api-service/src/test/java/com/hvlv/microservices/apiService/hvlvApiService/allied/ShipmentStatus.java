...
public class ShipmentStatus  implements java.io.Serializable {
    private com.hvlv.microservices.apiService.hvlvApiService.allied.ScanStatus[] statusBarcodesList;
    ...
    public ShipmentStatus(
           com.hvlv.microservices.apiService.hvlvApiService.allied.ScanStatus[] statusBarcodesList,
     ...
     */
    public com.hvlv.microservices.apiService.hvlvApiService.allied.ScanStatus[] getStatusBarcodesList() {
        return statusBarcodesList;
    }
     ...
     */
    public void setStatusBarcodesList(com.hvlv.microservices.apiService.hvlvApiService.allied.ScanStatus[] statusBarcodesList) {
        this.statusBarcodesList = statusBarcodesList;
    }

    public com.hvlv.microservices.apiService.hvlvApiService.allied.ScanStatus getStatusBarcodesList(int i) {
        return this.statusBarcodesList[i];
    }

    public void setStatusBarcodesList(int i, com.hvlv.microservices.apiService.hvlvApiService.allied.ScanStatus _value) {
