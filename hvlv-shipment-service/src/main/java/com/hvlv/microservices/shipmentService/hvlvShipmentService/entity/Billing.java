...
public class Billing implements Serializable {
    ...
    public String getBillingcol() {
        return billingcol;
    }

    public void setBillingcol(String billingcol) {
        this.billingcol = billingcol;
    }
    ...
    public String toString() {
        ...
        sb.append(", billingcol=").append(billingcol);
