...
public class Shipment extends MetaModel implements Serializable {
    private Integer id;
    ...
    private  Addr notifier;
    private  Org agent;
    protected JSONArray packs;
    private BigDecimal courierWeight;
    private  BigDecimal cubeWeight;

    public BigDecimal getCourierWeight() {
        return courierWeight;
    }

    public void setCourierWeight(BigDecimal courierWeight) {
        this.courierWeight = courierWeight;
    }

    public BigDecimal getCubeWeight() {
        return cubeWeight;
    }

    public void setCubeWeight(BigDecimal cubeWeight) {
        this.cubeWeight = cubeWeight;
    }

    public JSONArray getPacks() {
        if (this.packages!=null && !this.packages.isEmpty()){
            this.packs = JSON.parseArray(this.packages);
            return packs;
        }
        else {
            return null;
    ...
    public void setPacks(JSONArray packs) {
        if (packs != null){
            this.packages = JSONObject.toJSONString(this.packs);
        }
    }

    public Addr getNotifier() {
        return notifier;
    }

    public void setNotifier(Addr notifier) {
